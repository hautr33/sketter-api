...
import { approveDestination, createDestination, deleteOneDestination, getAllDestination, getOneDestination, getPendingDestination, getRejectDestination, rejectDestination, updateDestination } from "../controllers/app/destination.controller";
